...
BACKGROUND = pygame.image.load('image/background@2x.png')
...
def draw_next_shape(shape, surface):
    ...
    label = font.render('Next Shape', 1, (3,41,133))
...
def draw_window(surface, grid, score=0):
    ...
    #show current score
    font = pygame.font.SysFont('britannic', 30)
    label = font.render('Score: ' + str(score), 1, (3,41,133))
...
def main(win):
    ...
    while run:
        ...
        if time.time() - start_time > win_time:
